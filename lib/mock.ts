...
export function getMockAnalysisResults(params: any): any {
  ...
  const results = {
    ...
    images: {
      preFireImage: "/placeholder.svg?height=400&width=600&text=Pre-Fire+Image",
      postFireImage: "/placeholder.svg?height=400&width=600&text=Post-Fire+Image",
      preFireNBR: "/placeholder.svg?height=400&width=600&text=Pre-Fire+NBR",
      postFireNBR: "/placeholder.svg?height=400&width=600&text=Post-Fire+NBR",
      dNBR: "/placeholder.svg?height=400&width=600&text=dNBR+Map",
      burnSeverity: "/placeholder.svg?height=400&width=600&text=Burn+Severity+Map",
      burnSeverityLegend: "/placeholder.svg?height=100&width=400&text=Burn+Severity+Legend",
    },
    status: "completed",
